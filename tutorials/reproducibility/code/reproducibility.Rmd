...
1) Poisson fit to the *probability* of spider counts
2) Poisson fit to the *probability* of sowbug counts
3) Poisson fit to the *probability* of weevil counts
4) LGP fit to the *probability* of spider counts
5) LGP fit to the *probability* of sowbug counts
6) LGP fit to the *probability* of weevil counts
...
2) Add all members of your group as collaborators, plus Graham (username: grahamas)
