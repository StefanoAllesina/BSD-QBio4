...
Make three figures of Poisson fits to the *probability* of bug counts, one for each spiders, sowbugs, and weevils. Each figure should have datapoints corresponding to empirical data, and lines corresponding to theoretical distribution. Indicate in the README how well the Poisson distribution fits these data sets.

TODO: Add other distributions that do fit sowbugs
